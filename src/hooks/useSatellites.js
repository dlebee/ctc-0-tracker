...
const parseData = (text) => {
    ...
    if (!result.find((t) => t.name === 'Santa Claus 🎅')) {
        result.push({
            id: "00000",
            name: "Santa Claus 🎅",
            tle1: "1 00000HU 98067A   24359.68458358  .00023188  00000+0  41052-3 0  9996",
    ...
    result.push({
        ...
        tle1: "1 43205U 24048A   24338.88712994 -.00004807  00000+0  00000+0 0  9990",
        tle2: "2 43205  29.5806 355.5889 3256158 188.2034 162.4923  1.03009986    15"
    });
